...
//                         </form>
//
//                         <p className="text--center">Have an account? <Link to="/login">Log In</Link>
//                             <svg className="icon">
            ...
            <div className="align">
                <div className="grid">
                    ...
                    <h1 style={{
                        textAlign: "center",
                        marginTop: "100px",
                    }}>Creaza contu signup new user</h1>
                    ...
                    <p className="text--center">Or have an account? <Link to="/login">Sign In </Link>
                        <svg className="icon">
                            <use href="#icon-arrow-right"></use>
                        </svg>
                    </p>
